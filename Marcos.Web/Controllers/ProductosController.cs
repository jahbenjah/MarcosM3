...
namespace Marcos.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(MarcosDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Precio,UnidadDeMedida")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
