...
namespace MarcosM3.Web.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(MarcosM3DbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,RazonSocial,Direccion,RFC,Telefono,Correo,RequiereFactura")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
